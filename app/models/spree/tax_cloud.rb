  ...
  class TaxCloud
    ...
    def self.transaction_from_order(order)
      ...
      transaction = ::TaxCloud::Transaction.new(
        customer_id: order.user_id || order.external_user_id || order.email,
    ...
    def self.cart_item_from_item(item, index)
      if item.class.name.demodulize == "LineItem"
        ...
        ::TaxCloud::CartItem.new(
          ...
          price:      [line_item.discounted_amount, 0].max / line_item.quantity,
        ...
        ::TaxCloud::CartItem.new(
          ...
          price:      [shipment.discounted_amount, 0].max,
          quantity:   1
        )
